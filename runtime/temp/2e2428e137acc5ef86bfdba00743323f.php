<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:45:"./template/mobile/new/goods\categoryList.html";i:1499420874;s:40:"./template/mobile/new/public\header.html";i:1502075026;s:41:"./template/mobile/new/public\top_nav.html";i:1499420874;}*/ ?>
<!-- <!DOCTYPE html >
<html>
<head>
            ...
            <?php $j = '0'; if(is_array($goods_category_tree) || $goods_category_tree instanceof \think\Collection): if( count($goods_category_tree)==0 ) : echo "" ;else: foreach($goods_category_tree as $kk=>$vo): ?>
                <div class="branchList" >
                    ...
                    <div class="tp-bann"  data-id="<?php echo $j++; ?>">
                        <?php $pid =400;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1502431200 and end_time > 1502431200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
