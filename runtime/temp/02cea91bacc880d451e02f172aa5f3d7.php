<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/mobile/new/goods\goodsInfo.html";i:1502076244;s:40:"./template/mobile/new/public\header.html";i:1502075026;s:41:"./template/mobile/new/public\top_nav.html";i:1499420874;s:42:"./template/mobile/new/public\wx_share.html";i:1490353004;}*/ ?>
<!-- <!DOCTYPE html >
<html>
<head>
            ...
            <div class="scunde p">
                ...
                <p>销量：<span><?php echo $goods['sales_sum']; ?></span>
                    <span class="kc">当前库存：<span>
                        <?php if(empty($goods['flash_sale']) || ($goods['flash_sale'] instanceof \think\Collection && $goods['flash_sale']->isEmpty())): ?><?php echo $goods['store_count']; else: ?><?php echo $goods['flash_sale']['goods_num']-$goods['flash_sale']['buy_num']; endif; ?>
                    </span>
                    </span>
                </p>
            </div>
    ...
    <div class="choose_shop_aready p">
        ...
        <div class="shop-top-under p">
            <div class="maleri30">
                ...
                <?php if(empty($goods['flash_sale']) || ($goods['flash_sale'] instanceof \think\Collection && $goods['flash_sale']->isEmpty())): if($filter_spec != ''): if(is_array($filter_spec) || $filter_spec instanceof \think\Collection): if( count($filter_spec)==0 ) : echo "" ;else: foreach($filter_spec as $key=>$spec): ?>
...
//完
    ...
    function get_goods_price()
    {
        ...
        // 优先显示抢购活动库存
        <?php if(!(empty($goods['flash_sale']) || ($goods['flash_sale'] instanceof \think\Collection && $goods['flash_sale']->isEmpty()))): ?>
