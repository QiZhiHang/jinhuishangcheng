<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./template/mobile/new/goods\ajaxComment.html";i:1499420874;}*/ ?>
<?php if($count > 0): ?>
     ...
     <?php if(is_array($commentlist) || $commentlist instanceof \think\Collection): if( count($commentlist)==0 ) : echo "" ;else: foreach($commentlist as $k=>$v): ?>
            <span class="assess-wrapper"  >
                ...
                <div class="assess-bottom">
                    ...
                    <!--商家回复-s-->
                    <?php if(is_array($replyList[$v['comment_id']]) || $replyList[$v['comment_id']] instanceof \think\Collection): if( count($replyList[$v['comment_id']])==0 ) : echo "" ;else: foreach($replyList[$v['comment_id']] as $k=>$reply): ?>
