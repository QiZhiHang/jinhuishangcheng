<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:45:"./template/mobile/new/goods\integralMall.html";i:1499420874;s:40:"./template/mobile/new/public\header.html";i:1502075026;s:44:"./template/mobile/new/public\header_nav.html";i:1499420874;}*/ ?>
<!-- <!DOCTYPE html >
<html>
<head>
...
<div class="flool tpnavf">
    ...
    <!--换购商品列表-s-->
    <div id="goods_list">
        <?php if(is_array($goods_list) || $goods_list instanceof \think\Collection): if( count($goods_list)==0 ) : echo "" ;else: foreach($goods_list as $key=>$good): ?>
