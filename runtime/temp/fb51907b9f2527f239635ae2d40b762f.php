<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./template/mobile/new/user\order_detail.html";i:1502085384;s:42:"./template/mobile/new/public\header11.html";i:1502075948;s:38:"./template/mobile/new/public\menu.html";i:1490353004;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<div id="tbh5v0">						
	<div class="order">
		...
		<div class="detail_top">
			...
			<dd style=" margin-left:30px;"><span class="zhif">所选支付方式&nbsp;:&nbsp;<?php echo (isset($order_info['pay_name']) && ($order_info['pay_name'] !== '')?$order_info['pay_name']:"余额积分支付"); ?></span>
