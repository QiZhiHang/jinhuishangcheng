<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view2/user\recharge.html";i:1495533726;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
                    ...
                    <?php if(is_array($lists) || $lists instanceof \think\Collection): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                ...
                                <?php echo date("Y-m-d H:i",$list['pay_time']); endif; ?>
                                
                                </div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php if($list[pay_status] == 0): ?>待支付
                                <?php elseif($list[pay_status] == 1): ?>已支付
                                <?php elseif($list[pay_status] == -1): ?>已取消
                                <?php else: ?>已支付<?php endif; ?></div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    
                                    <?php if(in_array($list[pay_status],array(0))): ?>
                                        <a href="<?php echo U('editRecharge',array('id'=>$list['order_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>确认充值</a>
                                    
                                    <?php endif; if(in_array($list[pay_status],array(0))): ?>
                                        <a class="btn red"  href="<?php echo U('delRecharge',array('id'=>$list['order_id'])); ?>" ><i class="fa fa-trash-o"></i>取消</a>
                                    <?php endif; ?>
                                </div>
                            </td>
