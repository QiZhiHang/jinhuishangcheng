                 ...
                 <div class="xm-input-number">
                   <div class="act_wrap">
                        <a href="javascript:;" onclick="switch_num(-1,<?php echo $v['id']; ?>,<?php echo $v['store_count']; ?>);" id="jiannum6" class="input-sub active"></a>
                     	<input id="goods_num[<?php echo $v['id']; ?>]" type="text" onKeyDown='if(event.keyCode == 13) event.returnValue = false' name="goods_num[<?php echo $v['id']; ?>]"  value="<?php if($v[goods_num] > $v[store_count]): ?><?php echo $v[store_count]; else: ?><?php echo $v[goods_num]; endif; ?>"  class="input-num"  onblur="ajax_cart_list()"/>
