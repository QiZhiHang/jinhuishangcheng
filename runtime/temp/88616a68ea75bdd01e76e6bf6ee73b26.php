<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/order\detail.html";i:1490352994;s:44:"./application/admin/view2/public\layout.html";i:1490352994;}*/ ?>
<!doctype html>
<html>
<head>
      ...
      <form id="order-action">
        ...
        <div class="misc-info">
           <h3>基本信息</h3>
	              ...
	              <dl>
			       ...
			       <dl>
	              	<dt>订单状态:</dt>
		            <dd><?php echo $order_status[$order[order_status]]; ?> / <?php echo $pay_status[$order[pay_status]]; if($order['pay_code'] == 'cod'): ?><span style="color: red">(货到付款)</span><?php endif; ?> / <?php echo $shipping_status[$order[shipping_status]]; ?></dd>
		            <dt>下单时间:</dt>
		            <dd><?php echo date('Y-m-d H:i',$order['add_time']); ?></dd>
		            <dt>支付时间:</dt>
		            <dd><?php if($order['pay_time'] != 0): ?><?php echo date('Y-m-d H:i',$order['pay_time']); else: ?>N<?php endif; ?></dd>
			       </dl>
			       <dl>
	              	<dt>支付方式:</dt>
        ...
        <div class="goods-info">
          ...
          <table>
            ...
            <tbody>
            <?php if(is_array($orderGoods) || $orderGoods instanceof \think\Collection): $i = 0; $__LIST__ = $orderGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?>
           	<tr>
        ...
        <div class="contact-info">
	      ...
	      <dl class="row">
	        ...
	        <dd class="opt" style="margin-left:10px">
	         	<?php if(is_array($button) || $button instanceof \think\Collection): if( count($button)==0 ) : echo "" ;else: foreach($button as $k=>$vo): if($k == 'pay_cancel'): ?>
        ...
        <div class="goods-info">
          ...
          <table>
            ...
            <tbody>
            <?php if(is_array($action_log) || $action_log instanceof \think\Collection): $i = 0; $__LIST__ = $action_log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?>
	           	<tr>
	                 <td class="text-center"><?php if($log['action_user'] == 0): ?>管理员<?php else: ?><?php echo $users[1]; endif; ?></td>
